(set-env!
  ...
  :dependencies '[[org.clojure/clojure    "1.8.0"      :scope "provided"]
                  ...
                  ;; Dev
                  [cljsjs/leaflet "1.1.0-0" :scope "test"]
                  [cljsjs/react "15.6.1-1" :scope "test"]
                  [cljsjs/react-dom "15.6.1-1" :scope "test"]
                  [cljsjs/react-dom-server "15.6.1-1" :scope "test"]
                  [cljsjs/react-leaflet "1.4.1-0" :scope "test"]
                  [cljsjs/react-input-autosize "1.1.0-1" :scope "test"]
