 ...
 * - `:text` Text
 */
komponentit.dropdown.__GT_menu_item = (function komponentit$dropdown$__GT_menu_item(open_QMARK_,p__37511,p__37512){
...
var dropdown_opts = map__37513__$1;
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37513__$1,cljs.core.cst$kw$on_DASH_change);
var close_on_click_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37513__$1,cljs.core.cst$kw$close_DASH_on_DASH_click_QMARK_);
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37513__$1,cljs.core.cst$kw$disabled);
var active_item_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37513__$1,cljs.core.cst$kw$active_DASH_item_DASH_class,"dropdown-menu__item--active");
var separator_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37513__$1,cljs.core.cst$kw$separator_DASH_class,"divider");
var menu_item_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37513__$1,cljs.core.cst$kw$menu_DASH_item_DASH_class);
var menu_item_a_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37513__$1,cljs.core.cst$kw$menu_DASH_item_DASH_a_DASH_class);
...
var item_opts = map__37514__$1;
var separator = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37514__$1,cljs.core.cst$kw$separator);
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37514__$1,cljs.core.cst$kw$href);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37514__$1,cljs.core.cst$kw$text);
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37514__$1,cljs.core.cst$kw$props);
var el = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37514__$1,cljs.core.cst$kw$el,cljs.core.cst$kw$li);
var link_el = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37514__$1,cljs.core.cst$kw$link_DASH_el,cljs.core.cst$kw$a);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37514__$1,cljs.core.cst$kw$key);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37514__$1,cljs.core.cst$kw$value);
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37514__$1,cljs.core.cst$kw$on_DASH_click);
var link_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37514__$1,cljs.core.cst$kw$link_DASH_props);
...
komponentit.dropdown.caret_SINGLEQUOTE_ = (function komponentit$dropdown$caret_SINGLEQUOTE_(open_QMARK_,p__37517){
...
var caret_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37518__$1,cljs.core.cst$kw$caret_QMARK_);
var caret_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37518__$1,cljs.core.cst$kw$caret_DASH_class,"caret");
var caret_up_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37518__$1,cljs.core.cst$kw$caret_DASH_up_DASH_class,"caret");
...
komponentit.dropdown.dropdown_SINGLEQUOTE_ = (function komponentit$dropdown$dropdown_SINGLEQUOTE_(open_QMARK_,ref,dropdown,p__37520){
...
var props = map__37521__$1;
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37521__$1,cljs.core.cst$kw$text);
var a_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37521__$1,cljs.core.cst$kw$a_DASH_class);
var container_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37521__$1,cljs.core.cst$kw$container_DASH_class,"dropdown-container");
var el = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37521__$1,cljs.core.cst$kw$el,cljs.core.cst$kw$a);
var button_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37521__$1,cljs.core.cst$kw$button_DASH_class);
var toggle_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37521__$1,cljs.core.cst$kw$toggle_DASH_props);
var open_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37521__$1,cljs.core.cst$kw$open_DASH_class,"open");
var container_el = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37521__$1,cljs.core.cst$kw$container_DASH_el,cljs.core.cst$kw$div);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37521__$1,cljs.core.cst$kw$class);
var li_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37521__$1,cljs.core.cst$kw$li_DASH_class);
var toggle_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37521__$1,cljs.core.cst$kw$toggle_DASH_class,"dropdown-toggle");
return null;
});
/**
...
return (function (p__37523){
var map__37524 = p__37523;
var map__37524__$1 = (((((!((map__37524 == null))))?(((((map__37524.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37524.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37524):map__37524);
var props = map__37524__$1;
var container_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$container_DASH_props);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$text);
var a_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$a_DASH_class);
var container_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37524__$1,cljs.core.cst$kw$container_DASH_class,"dropdown-container");
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$children);
var el = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37524__$1,cljs.core.cst$kw$el,cljs.core.cst$kw$a);
var button_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$button_DASH_class);
var toggle_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$toggle_DASH_props);
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$content);
var open_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37524__$1,cljs.core.cst$kw$open_DASH_class,"open");
var dropdown_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37524__$1,cljs.core.cst$kw$dropdown_DASH_class,"dropdown-menu");
var container_el = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37524__$1,cljs.core.cst$kw$container_DASH_el,cljs.core.cst$kw$div);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$class);
var li_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37524__$1,cljs.core.cst$kw$li_DASH_class);
var toggle_class = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37524__$1,cljs.core.cst$kw$toggle_DASH_class,"dropdown-toggle");
