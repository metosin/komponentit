...
var G__32866 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(by_id__$1,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(item__$1),item__$1);
var G__32867 = cljs.core.cst$kw$items.cljs$core$IFn$_invoke$arity$1(item__$1);
var G__32868 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(item__$1));
return (example.autocomplete_tree.tree_items_by_id.cljs$core$IFn$_invoke$arity$3 ? example.autocomplete_tree.tree_items_by_id.cljs$core$IFn$_invoke$arity$3(G__32866,G__32867,G__32868) : example.autocomplete_tree.tree_items_by_id.call(null,G__32866,G__32867,G__32868));
}),by_id,items);
});
...
if((typeof example !== 'undefined') && (typeof example.autocomplete_tree !== 'undefined') && (typeof example.autocomplete_tree.t_example$autocomplete_tree32869 !== 'undefined')){
} else {
...
*/
example.autocomplete_tree.t_example$autocomplete_tree32869 = (function (meta32870){
this.meta32870 = meta32870;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.autocomplete_tree.t_example$autocomplete_tree32869.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32871,meta32870__$1){
var self__ = this;
var _32871__$1 = this;
return (new example.autocomplete_tree.t_example$autocomplete_tree32869(meta32870__$1));
}));

(example.autocomplete_tree.t_example$autocomplete_tree32869.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32871){
var self__ = this;
var _32871__$1 = this;
return self__.meta32870;
}));

(example.autocomplete_tree.t_example$autocomplete_tree32869.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.autocomplete_tree.t_example$autocomplete_tree32869.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
...
var map__32872 = temp__4655__auto__;
var map__32872__$1 = (((((!((map__32872 == null))))?(((((map__32872.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32872.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__32872):map__32872);
var id__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32872__$1,cljs.core.cst$kw$id);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32872__$1,cljs.core.cst$kw$name);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32872__$1,cljs.core.cst$kw$path);
...
(example.autocomplete_tree.t_example$autocomplete_tree32869.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32870], null);
}));

(example.autocomplete_tree.t_example$autocomplete_tree32869.cljs$lang$type = true);

(example.autocomplete_tree.t_example$autocomplete_tree32869.cljs$lang$ctorStr = "example.autocomplete-tree/t_example$autocomplete_tree32869");

(example.autocomplete_tree.t_example$autocomplete_tree32869.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.autocomplete-tree/t_example$autocomplete_tree32869");
}));

/**
 * Positional factory function for example.autocomplete-tree/t_example$autocomplete_tree32869.
 */
example.autocomplete_tree.__GT_t_example$autocomplete_tree32869 = (function example$autocomplete_tree$__GT_t_example$autocomplete_tree32869(meta32870){
return (new example.autocomplete_tree.t_example$autocomplete_tree32869(meta32870));
});

}

return (new example.autocomplete_tree.t_example$autocomplete_tree32869(null));
})()
...
if((depth > (0))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(item,cljs.core.cst$kw$items,(function (){var G__32874 = index;
var G__32875 = ((n - (2)) / (2));
var G__32876 = (depth - (1));
return (example.autocomplete_tree.create_tree.cljs$core$IFn$_invoke$arity$3 ? example.autocomplete_tree.create_tree.cljs$core$IFn$_invoke$arity$3(G__32874,G__32875,G__32876) : example.autocomplete_tree.create_tree.call(null,G__32874,G__32875,G__32876));
})());
} else {
return item;
}
...
if((typeof example !== 'undefined') && (typeof example.autocomplete_tree !== 'undefined') && (typeof example.autocomplete_tree.t_example$autocomplete_tree32877 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
example.autocomplete_tree.t_example$autocomplete_tree32877 = (function (meta32878){
this.meta32878 = meta32878;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.autocomplete_tree.t_example$autocomplete_tree32877.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32879,meta32878__$1){
var self__ = this;
var _32879__$1 = this;
return (new example.autocomplete_tree.t_example$autocomplete_tree32877(meta32878__$1));
}));

(example.autocomplete_tree.t_example$autocomplete_tree32877.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32879){
var self__ = this;
var _32879__$1 = this;
return self__.meta32878;
}));

(example.autocomplete_tree.t_example$autocomplete_tree32877.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.autocomplete_tree.t_example$autocomplete_tree32877.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
var this__31346__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__31347__auto__,cljs.core.cst$kw$main_DASH_obj,(function (){var v__31365__auto__ = (function (value,_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [komponentit.autocomplete.autocomplete,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$cb,cljs.core.cst$kw$item_DASH__GT_text,cljs.core.cst$kw$search_DASH_fields,cljs.core.cst$kw$item_DASH__GT_key,cljs.core.cst$kw$value,cljs.core.cst$kw$item_DASH__GT_items,cljs.core.cst$kw$value_DASH__GT_text,cljs.core.cst$kw$debounce_DASH_timeout,cljs.core.cst$kw$items],[(function (item){
...
var temp__4655__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(items_by_id,id);
if(cljs.core.truth_(temp__4655__auto__)){
var map__32880 = temp__4655__auto__;
var map__32880__$1 = (((((!((map__32880 == null))))?(((((map__32880.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32880.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__32880):map__32880);
var id__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32880__$1,cljs.core.cst$kw$id);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32880__$1,cljs.core.cst$kw$name);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32880__$1,cljs.core.cst$kw$path);
var path__$1 = clojure.string.join.cljs$core$IFn$_invoke$arity$2(" > ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$name,items_by_id),path));
return [((cljs.core.seq(path__$1))?[path__$1," > "].join(''):null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)," (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id__$1),")"].join('');
} else {
return ["Unknown item, ID: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)].join('');
...
(example.autocomplete_tree.t_example$autocomplete_tree32877.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32878], null);
}));

(example.autocomplete_tree.t_example$autocomplete_tree32877.cljs$lang$type = true);

(example.autocomplete_tree.t_example$autocomplete_tree32877.cljs$lang$ctorStr = "example.autocomplete-tree/t_example$autocomplete_tree32877");

(example.autocomplete_tree.t_example$autocomplete_tree32877.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.autocomplete-tree/t_example$autocomplete_tree32877");
}));

/**
 * Positional factory function for example.autocomplete-tree/t_example$autocomplete_tree32877.
 */
example.autocomplete_tree.__GT_t_example$autocomplete_tree32877 = (function example$autocomplete_tree$__GT_t_example$autocomplete_tree32877(meta32878){
return (new example.autocomplete_tree.t_example$autocomplete_tree32877(meta32878));
});

}

return (new example.autocomplete_tree.t_example$autocomplete_tree32877(null));
})()
,cljs.core.cst$kw$initial_DASH_data,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null),cljs.core.cst$kw$options,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$watch_DASH_atom,false], null)], null));
})], null));
...
}catch (e32882){var t__31051__auto__ = e32882;
...
return result__31007__auto__;
}catch (e32883){var t__31051__auto__ = e32883;
return cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$error,cljs.core.cst$kw$expected,cljs.core.list(cljs.core.cst$sym$_EQ_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["foo"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["bar"], null)], null),cljs.core.list(cljs.core.cst$sym$autocomplete_SLASH_sub_DASH_query_DASH_match_QMARK_,cljs.core.cst$sym$match_DASH_fn,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$name,"foo"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["foo","bar"], null))),cljs.core.cst$kw$actual,t__31051__auto__,cljs.core.cst$kw$message,null], null));
}});
