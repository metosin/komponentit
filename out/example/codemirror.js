...
if((typeof example !== 'undefined') && (typeof example.codemirror !== 'undefined') && (typeof example.codemirror.t_example$codemirror32910 !== 'undefined')){
} else {
...
*/
example.codemirror.t_example$codemirror32910 = (function (meta32911){
this.meta32911 = meta32911;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.codemirror.t_example$codemirror32910.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32912,meta32911__$1){
var self__ = this;
var _32912__$1 = this;
return (new example.codemirror.t_example$codemirror32910(meta32911__$1));
}));

(example.codemirror.t_example$codemirror32910.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32912){
var self__ = this;
var _32912__$1 = this;
return self__.meta32911;
}));

(example.codemirror.t_example$codemirror32910.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.codemirror.t_example$codemirror32910.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
...
(example.codemirror.t_example$codemirror32910.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32911], null);
}));

(example.codemirror.t_example$codemirror32910.cljs$lang$type = true);

(example.codemirror.t_example$codemirror32910.cljs$lang$ctorStr = "example.codemirror/t_example$codemirror32910");

(example.codemirror.t_example$codemirror32910.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.codemirror/t_example$codemirror32910");
}));

/**
 * Positional factory function for example.codemirror/t_example$codemirror32910.
 */
example.codemirror.__GT_t_example$codemirror32910 = (function example$codemirror$__GT_t_example$codemirror32910(meta32911){
return (new example.codemirror.t_example$codemirror32910(meta32911));
});

}

return (new example.codemirror.t_example$codemirror32910(null));
})()
...
if((typeof example !== 'undefined') && (typeof example.codemirror !== 'undefined') && (typeof example.codemirror.t_example$codemirror32914 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
example.codemirror.t_example$codemirror32914 = (function (meta32915){
this.meta32915 = meta32915;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.codemirror.t_example$codemirror32914.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32916,meta32915__$1){
var self__ = this;
var _32916__$1 = this;
return (new example.codemirror.t_example$codemirror32914(meta32915__$1));
}));

(example.codemirror.t_example$codemirror32914.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32916){
var self__ = this;
var _32916__$1 = this;
return self__.meta32915;
}));

(example.codemirror.t_example$codemirror32914.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.codemirror.t_example$codemirror32914.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
var this__31346__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__31347__auto__,cljs.core.cst$kw$main_DASH_obj,(function (){var v__31365__auto__ = (function (state,_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [komponentit.codemirror.codemirror,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$value,cljs.core.cst$kw$code.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.cst$kw$on_DASH_mount,(function (p1__32913_SHARP_){
var G__32917 = p1__32913_SHARP_;
var G__32918 = "smart";
var G__32919 = ({});
return example.codemirror.global$module$parinfer_codemirror.init(G__32917,G__32918,G__32919);
...
(example.codemirror.t_example$codemirror32914.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32915], null);
}));

(example.codemirror.t_example$codemirror32914.cljs$lang$type = true);

(example.codemirror.t_example$codemirror32914.cljs$lang$ctorStr = "example.codemirror/t_example$codemirror32914");

(example.codemirror.t_example$codemirror32914.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.codemirror/t_example$codemirror32914");
}));

/**
 * Positional factory function for example.codemirror/t_example$codemirror32914.
 */
example.codemirror.__GT_t_example$codemirror32914 = (function example$codemirror$__GT_t_example$codemirror32914(meta32915){
return (new example.codemirror.t_example$codemirror32914(meta32915));
});

}

return (new example.codemirror.t_example$codemirror32914(null));
})()
,cljs.core.cst$kw$initial_DASH_data,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$code,"(defn hello\n  []\n  \"world\")"], null)),cljs.core.cst$kw$options,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$inspect_DASH_data,true,cljs.core.cst$kw$watch_DASH_atom,false], null)], null));
})], null));
...
return ({"list": cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.array,(function (){var G__32921 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["foo","foobar","bar","hello",[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cur_word),"foo"].join('')], null);
if(cljs.core.truth_(cur_word)){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__32920_SHARP_){
return clojure.string.starts_with_QMARK_(p1__32920_SHARP_,cur_word);
}),G__32921);
} else {
return G__32921;
}
...
if((typeof example !== 'undefined') && (typeof example.codemirror !== 'undefined') && (typeof example.codemirror.t_example$codemirror32923 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
example.codemirror.t_example$codemirror32923 = (function (meta32924){
this.meta32924 = meta32924;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.codemirror.t_example$codemirror32923.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32925,meta32924__$1){
var self__ = this;
var _32925__$1 = this;
return (new example.codemirror.t_example$codemirror32923(meta32924__$1));
}));

(example.codemirror.t_example$codemirror32923.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32925){
var self__ = this;
var _32925__$1 = this;
return self__.meta32924;
}));

(example.codemirror.t_example$codemirror32923.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.codemirror.t_example$codemirror32923.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
var this__31346__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__31347__auto__,cljs.core.cst$kw$main_DASH_obj,(function (){var v__31365__auto__ = (function (state,_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [komponentit.codemirror.codemirror,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$value,cljs.core.cst$kw$code.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.cst$kw$on_DASH_change,(function (cm,change){
...
(example.codemirror.t_example$codemirror32923.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32924], null);
}));

(example.codemirror.t_example$codemirror32923.cljs$lang$type = true);

(example.codemirror.t_example$codemirror32923.cljs$lang$ctorStr = "example.codemirror/t_example$codemirror32923");

(example.codemirror.t_example$codemirror32923.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.codemirror/t_example$codemirror32923");
}));

/**
 * Positional factory function for example.codemirror/t_example$codemirror32923.
 */
example.codemirror.__GT_t_example$codemirror32923 = (function example$codemirror$__GT_t_example$codemirror32923(meta32924){
return (new example.codemirror.t_example$codemirror32923(meta32924));
});

}

return (new example.codemirror.t_example$codemirror32923(null));
})()
