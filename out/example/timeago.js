...
var G__32249 = (new goog.date.DateTime());
G__32249.add((new goog.date.Interval(interval,x)));

return G__32249;
});
example.timeago.ago = (function example$timeago$ago(x,interval){
var G__32250 = (new goog.date.DateTime());
G__32250.add((new goog.date.Interval(interval,x)).getInverse());
