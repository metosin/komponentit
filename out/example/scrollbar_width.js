...
if((typeof example !== 'undefined') && (typeof example.scrollbar_width !== 'undefined') && (typeof example.scrollbar_width.t_example$scrollbar_width32749 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
example.scrollbar_width.t_example$scrollbar_width32749 = (function (meta32750){
this.meta32750 = meta32750;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.scrollbar_width.t_example$scrollbar_width32749.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32751,meta32750__$1){
var self__ = this;
var _32751__$1 = this;
return (new example.scrollbar_width.t_example$scrollbar_width32749(meta32750__$1));
}));

(example.scrollbar_width.t_example$scrollbar_width32749.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32751){
var self__ = this;
var _32751__$1 = this;
return self__.meta32750;
}));

(example.scrollbar_width.t_example$scrollbar_width32749.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.scrollbar_width.t_example$scrollbar_width32749.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
var this__31346__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__31347__auto__,cljs.core.cst$kw$main_DASH_obj,(function (){var v__31365__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,"scrollbar.png"], null)], null)], null);
if(cljs.core.fn_QMARK_(v__31365__auto__)){
return (function (data_atom__31366__auto__,owner__31367__auto__){
return reagent.core.as_element(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [v__31365__auto__,data_atom__31366__auto__,owner__31367__auto__], null));
});
...
(example.scrollbar_width.t_example$scrollbar_width32749.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32750], null);
}));

(example.scrollbar_width.t_example$scrollbar_width32749.cljs$lang$type = true);

(example.scrollbar_width.t_example$scrollbar_width32749.cljs$lang$ctorStr = "example.scrollbar-width/t_example$scrollbar_width32749");

(example.scrollbar_width.t_example$scrollbar_width32749.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.scrollbar-width/t_example$scrollbar_width32749");
}));

/**
 * Positional factory function for example.scrollbar-width/t_example$scrollbar_width32749.
 */
example.scrollbar_width.__GT_t_example$scrollbar_width32749 = (function example$scrollbar_width$__GT_t_example$scrollbar_width32749(meta32750){
return (new example.scrollbar_width.t_example$scrollbar_width32749(meta32750));
});

}

return (new example.scrollbar_width.t_example$scrollbar_width32749(null));
})()
,cljs.core.cst$kw$initial_DASH_data,null,cljs.core.cst$kw$options,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$watch_DASH_atom,false], null)], null));
})], null));
