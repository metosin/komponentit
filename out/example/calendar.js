...
if((typeof example !== 'undefined') && (typeof example.calendar !== 'undefined') && (typeof example.calendar.t_example$calendar32904 !== 'undefined')){
} else {
...
*/
example.calendar.t_example$calendar32904 = (function (meta32905){
this.meta32905 = meta32905;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.calendar.t_example$calendar32904.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32906,meta32905__$1){
var self__ = this;
var _32906__$1 = this;
return (new example.calendar.t_example$calendar32904(meta32905__$1));
}));

(example.calendar.t_example$calendar32904.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32906){
var self__ = this;
var _32906__$1 = this;
return self__.meta32905;
}));

(example.calendar.t_example$calendar32904.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.calendar.t_example$calendar32904.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
...
(example.calendar.t_example$calendar32904.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32905], null);
}));

(example.calendar.t_example$calendar32904.cljs$lang$type = true);

(example.calendar.t_example$calendar32904.cljs$lang$ctorStr = "example.calendar/t_example$calendar32904");

(example.calendar.t_example$calendar32904.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.calendar/t_example$calendar32904");
}));

/**
 * Positional factory function for example.calendar/t_example$calendar32904.
 */
example.calendar.__GT_t_example$calendar32904 = (function example$calendar$__GT_t_example$calendar32904(meta32905){
return (new example.calendar.t_example$calendar32904(meta32905));
});

}

return (new example.calendar.t_example$calendar32904(null));
})()
...
if((typeof example !== 'undefined') && (typeof example.calendar !== 'undefined') && (typeof example.calendar.t_example$calendar32908 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
example.calendar.t_example$calendar32908 = (function (meta32909){
this.meta32909 = meta32909;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.calendar.t_example$calendar32908.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32910,meta32909__$1){
var self__ = this;
var _32910__$1 = this;
return (new example.calendar.t_example$calendar32908(meta32909__$1));
}));

(example.calendar.t_example$calendar32908.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32910){
var self__ = this;
var _32910__$1 = this;
return self__.meta32909;
}));

(example.calendar.t_example$calendar32908.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.calendar.t_example$calendar32908.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
var this__31346__auto____$1 = this;
...
}),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$week_DASH_numbers_QMARK_,cljs.core.cst$kw$bool], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$quicklist_QMARK_,cljs.core.cst$kw$bool], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$date_DASH_input_QMARK_,cljs.core.cst$kw$bool], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [komponentit.calendar.date_range,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$start,cljs.core.cst$kw$start.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.cst$kw$end,cljs.core.cst$kw$end.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.cst$kw$on_DASH_change,(function (p1__32907_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(state,cljs.core.merge,p1__32907_SHARP_);
...
(example.calendar.t_example$calendar32908.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32909], null);
}));

(example.calendar.t_example$calendar32908.cljs$lang$type = true);

(example.calendar.t_example$calendar32908.cljs$lang$ctorStr = "example.calendar/t_example$calendar32908");

(example.calendar.t_example$calendar32908.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.calendar/t_example$calendar32908");
}));

/**
 * Positional factory function for example.calendar/t_example$calendar32908.
 */
example.calendar.__GT_t_example$calendar32908 = (function example$calendar$__GT_t_example$calendar32908(meta32909){
return (new example.calendar.t_example$calendar32908(meta32909));
});

}

return (new example.calendar.t_example$calendar32908(null));
})()
