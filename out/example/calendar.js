...
if((typeof example !== 'undefined') && (typeof example.calendar !== 'undefined') && (typeof example.calendar.t_example$calendar32901 !== 'undefined')){
} else {
...
*/
example.calendar.t_example$calendar32901 = (function (meta32902){
this.meta32902 = meta32902;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.calendar.t_example$calendar32901.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32903,meta32902__$1){
var self__ = this;
var _32903__$1 = this;
return (new example.calendar.t_example$calendar32901(meta32902__$1));
}));

(example.calendar.t_example$calendar32901.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32903){
var self__ = this;
var _32903__$1 = this;
return self__.meta32902;
}));

(example.calendar.t_example$calendar32901.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.calendar.t_example$calendar32901.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
...
(example.calendar.t_example$calendar32901.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32902], null);
}));

(example.calendar.t_example$calendar32901.cljs$lang$type = true);

(example.calendar.t_example$calendar32901.cljs$lang$ctorStr = "example.calendar/t_example$calendar32901");

(example.calendar.t_example$calendar32901.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.calendar/t_example$calendar32901");
}));

/**
 * Positional factory function for example.calendar/t_example$calendar32901.
 */
example.calendar.__GT_t_example$calendar32901 = (function example$calendar$__GT_t_example$calendar32901(meta32902){
return (new example.calendar.t_example$calendar32901(meta32902));
});

}

return (new example.calendar.t_example$calendar32901(null));
})()
...
if((typeof example !== 'undefined') && (typeof example.calendar !== 'undefined') && (typeof example.calendar.t_example$calendar32905 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
example.calendar.t_example$calendar32905 = (function (meta32906){
this.meta32906 = meta32906;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.calendar.t_example$calendar32905.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32907,meta32906__$1){
var self__ = this;
var _32907__$1 = this;
return (new example.calendar.t_example$calendar32905(meta32906__$1));
}));

(example.calendar.t_example$calendar32905.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32907){
var self__ = this;
var _32907__$1 = this;
return self__.meta32906;
}));

(example.calendar.t_example$calendar32905.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.calendar.t_example$calendar32905.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
var this__31346__auto____$1 = this;
...
}),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$week_DASH_numbers_QMARK_,cljs.core.cst$kw$bool], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$quicklist_QMARK_,cljs.core.cst$kw$bool], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$date_DASH_input_QMARK_,cljs.core.cst$kw$bool], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [komponentit.calendar.date_range,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$start,cljs.core.cst$kw$start.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.cst$kw$end,cljs.core.cst$kw$end.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.cst$kw$on_DASH_change,(function (p1__32904_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(state,cljs.core.merge,p1__32904_SHARP_);
...
(example.calendar.t_example$calendar32905.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32906], null);
}));

(example.calendar.t_example$calendar32905.cljs$lang$type = true);

(example.calendar.t_example$calendar32905.cljs$lang$ctorStr = "example.calendar/t_example$calendar32905");

(example.calendar.t_example$calendar32905.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.calendar/t_example$calendar32905");
}));

/**
 * Positional factory function for example.calendar/t_example$calendar32905.
 */
example.calendar.__GT_t_example$calendar32905 = (function example$calendar$__GT_t_example$calendar32905(meta32906){
return (new example.calendar.t_example$calendar32905(meta32906));
});

}

return (new example.calendar.t_example$calendar32905(null));
})()
