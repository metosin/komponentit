...
if((typeof example !== 'undefined') && (typeof example.modal !== 'undefined') && (typeof example.modal.t_example$modal32899 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
example.modal.t_example$modal32899 = (function (meta32900){
this.meta32900 = meta32900;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(example.modal.t_example$modal32899.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32901,meta32900__$1){
var self__ = this;
var _32901__$1 = this;
return (new example.modal.t_example$modal32899(meta32900__$1));
}));

(example.modal.t_example$modal32899.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32901){
var self__ = this;
var _32901__$1 = this;
return self__.meta32900;
}));

(example.modal.t_example$modal32899.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(example.modal.t_example$modal32899.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__31346__auto__,devcard_opts__31347__auto__){
var self__ = this;
var this__31346__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__31347__auto__,cljs.core.cst$kw$main_DASH_obj,(function (){var v__31365__auto__ = (function (open_QMARK_,_){
...
(example.modal.t_example$modal32899.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta32900], null);
}));

(example.modal.t_example$modal32899.cljs$lang$type = true);

(example.modal.t_example$modal32899.cljs$lang$ctorStr = "example.modal/t_example$modal32899");

(example.modal.t_example$modal32899.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"example.modal/t_example$modal32899");
}));

/**
 * Positional factory function for example.modal/t_example$modal32899.
 */
example.modal.__GT_t_example$modal32899 = (function example$modal$__GT_t_example$modal32899(meta32900){
return (new example.modal.t_example$modal32899(meta32900));
});

}

return (new example.modal.t_example$modal32899(null));
})()
,cljs.core.cst$kw$initial_DASH_data,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false),cljs.core.cst$kw$options,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$watch_DASH_atom,false], null)], null));
})], null));
